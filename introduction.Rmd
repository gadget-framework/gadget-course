...
# General context of Gadget models
...
an observation. The time-steps within the observations allow for the
...
number of individuals in a certain age and length group within a
certain area. The stocks live in an area, or areas, where they
...
in @hirst2005estimating]. Essentially using VPA requires a two
...
based, and there is therefore no requirement fir the likelihood
