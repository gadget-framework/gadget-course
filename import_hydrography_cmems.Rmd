...
download.file(url="https://gis.ices.dk/shapefiles/ICES_StatRec_mapto_ICES_Areas.zip",
              destfile = "data_provided/ices_rect.zip", mode = "wb")
unzip("data_provided/ices_rect.zip")
```
...
# load ICES rect
ices.rect <- st_read("data_provided/StatRec_map_Areas_Full_20170124.dbf", quiet = TRUE)
