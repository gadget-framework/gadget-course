...
Maturation is split into a two-step process in Gadget. At what length they transition is defined
...
`transitionstocksandratios`) in the fourth time step of every year. 

Note that transition in Gadget is currently implemented as a process that occurs for 
...
we have only implmented length-dependency. The [Gadget User Guide](https://hafro.github.io/gadget/docs/userguide) describes other possible
maturity functions, which implement for example a dependency on body condition, instantaneous 
maturation (rather than seasonal or time-step-dependent transition), and step-wise maturation of whole stocks.
...
gadgetfleet('Modelfiles/fleet',gd,missingOkay = TRUE) %>% 
  gadget_update('totalfleet',
                name = 'surv',
                suitability = 
                  list(ling.imm = list(type='function',suit_func='exponentiall50',
                                       alpha = '#ling.surv.alpha',
                                       beta = '#ling.surv.l50'),
                       ling.mat = list(type='function',suit_func='exponentiall50',
                                       alpha = '#ling.surv.alpha',
                                       beta = '#ling.surv.l50')),
                data = surv.landings) %>%
  gadget_update('totalfleet',
                ...
                suitability = 
                  list(ling.imm = list(type='function',suit_func='exponentiall50',
                       ...
                       ling.mat = list(type='function',suit_func='exponentiall50',
                                       alpha = '#ling.lln.alpha',
                                       beta = '#ling.lln.l50')),
                  # list(ling.imm = list(type='function',suit_func='andersen',
                  #                      p0 = '#ling.lln.p0',
                  ...
                  #                      p4 = '#ling.lln.p4',
                  #                      L = '180'),
                  #      ling.mat =  list(type='function',suit_func='andersen',
                  #                      p0 = '#ling.lln.p0',
                  #                      p1 = to.gadget.formulae(quote(log(180/ling.lln.lmode))),
                  #                      p2 = '#ling.lln.p2',
                  #                      p3 = '#ling.lln.p3',
