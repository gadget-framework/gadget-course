...
timestamp() 
run <- gadget.iterative() # For linux, but Windows throws an error due to incompality in the parallel package
#run <- gadget.iterative(run.serial = TRUE) #This will work, but will take twice as long to run
timestamp()
