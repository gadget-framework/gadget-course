...
```{r}
read.gadget.file('data_provided', 'optinfofile')
```
...
load(paste(gd,'WGTS/WGTS.Rdata',sep='/'))
fit <- out
```

```{r,message=FALSE,eval=FALSE}

#Notice that we are still in the same directory as where gadget.iterative was run
getwd()
...
## go back to the old folder if necessary
#setwd(old)
